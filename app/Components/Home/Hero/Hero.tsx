...
{/*                     <button data-aos="zoom-in" data-aos-delay="300" className='md:px-8 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm md:text-lg transition all duration-200 rounded-lg mt-8 bg-blue-700 hover:bg-blue-900 flex items-center'>
                       <a href="https://drive.google.com/file/d/1tvxnDoHwgvHprRIOMfHG6Lq-zi4mnWee/view?usp=drivesdk">Download CV</a>
                        <FaDownload className='ml-[3px]'/>
                    </button> */}
                  <a href="https://drive.google.com/file/d/1tvxnDoHwgvHprRIOMfHG6Lq-zi4mnWee/view?usp=drivesdk"
                     target="_blank"
                     rel="noopener noreferrer"
                     className='inline-flex items-center md:px-8 md:py-2.5 px-6 py-1.5 text-white font-semibold text-sm md:text-lg transition-all duration-200 rounded-lg mt-8 bg-blue-700 hover:bg-blue-900'>
                        Download Resume
